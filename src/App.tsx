...
function AppContent() {
  ...
  const [categories, setCategories] = useState<Category[]>([
    ...
    { id: 5, name: '数码', color: '#ff6600' },
    { id: 6, name: '书籍', color: '#722ed1' },
  ])
    ...
    <div className="app">
      <div className="page-content">
        <Routes>
          ...
          <Route path="/categories" element={<CategoriesPage categories={categories} items={items} setCategories={setCategories} />} />
        </Routes>
      </div>
